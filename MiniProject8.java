...
public class MiniProject8 {
    ...
    /****************************************************
     ** Methods defining a Dinosaur ADT
     ** Theses are the only ways we can use to access the Dinosaur
     ** Get name
     ** Get favourite food
     ** Get favourite play
     ...
     ** Get Anger level
     ** get Danger Level
     ** Create a Dinosaur record
     ** Set anger, hunger and danger level on the record
     **/
    ...
    public static int[] readFileIntArray(int numb, String[] listDatabase) {
        String arr = listDatabase[numb];
        String[] items = arr.replaceAll(" ", "").replaceAll("\\[", "").replaceAll("\\]", "").replaceAll("\\s", "")
                .split(",");
    ...
    public static String[] readFileStringArray(int numb, String[] listDatabase) {
        String arr = listDatabase[numb];
        String[] items = arr.replaceAll(" ", "").replaceAll("\\[", "").replaceAll("]", "").replaceAll("\"", "")
                .split(",");
    ...
    public static String[] retrieveFile() throws IOException {
        String[] listDatabase = new String[13];
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (checkPreviousSession == true) {
            ...
            hungryLvlList = readFileIntArray(4, listDatabase);
            angryLvlList = readFileIntArray(3, listDatabase);
            dinosaursList = readFileStringArray(2, listDatabase);
